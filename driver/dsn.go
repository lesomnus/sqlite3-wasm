...
const (
	// TimeFormatOffset writes "2006-01-02 15:04:05.999999999-07:00", which is
	// the first parse layout and is understood by SQLite's datetime().
	TimeFormatOffset TimeFormat = iota
	// TimeFormatUTC writes "2006-01-02 15:04:05.999999999" in UTC. Unlike the
	// offset form it sorts and indexes correctly across zones.
	TimeFormatUTC
	// TimeFormatDatetime writes "2006-01-02 15:04:05".
	TimeFormatDatetime
)
